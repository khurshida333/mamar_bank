...
class UserRegistrationForm(UserCreationForm):
    ...
    def save(self, commit=True):
        our_user = super().save(commit=False)  # (automatically generated accunt no)In your UserRegistrationForm's save() method, you're already doing something like this: account_no = 100000 + our_user.id
        if commit == True:
            our_user.save()   #an id is assigned to it.
